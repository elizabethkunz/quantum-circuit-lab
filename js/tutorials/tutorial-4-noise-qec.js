/* =========================================================================
   T4 STEP 4: SURFACE CODE GRID + OVERHEAD CHART
   ========================================================================= */
(function initT4Step4() {
  ...
  function drawSurface() {
    ...
    for (let r = 0; r < 2; r++) {
      for (let c = 0; c < 2; c++) {
        ...
        const color = excited ? 'var(--red)' : (isZ ? 'rgba(255,184,101,0.18)' : 'rgba(111,212,224,0.18)');
  ...
  function updateStatus() {
    ...
    if (errors.size === 0) {
      if (st) st.innerHTML = '<span style="color:var(--phos)">No errors.</span> All stabilisers check out — the logical qubit is intact.';
    ...
    if (injected && errors.size === 0 && corrected) markDone('t4-4');
  }
  ...
  function drawOverhead() {
    ...
    // Axes
    svg.appendChild(Object.assign(document.createElementNS(ns,'line'), {setAttribute:()=>{}}));
